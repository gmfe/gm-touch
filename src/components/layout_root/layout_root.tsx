...
class LayerRoot extends Component<LayoutRootProps, LayoutRootState> {
  static _setComponentPopup = (id, com) => {
    _setComponentArray(LayerRoot.TYPE._POPUP, id, com)
  }

  static _removeComponentPopup = id => {
    _removeComponentArray(LayerRoot.TYPE._POPUP, id)
  }

  static _setComponentTip = (id, com) => {
    _setComponentArray(LayerRoot.TYPE.TIPS, id, com)
  }

  static _removeComponentTip = id => {
    _removeComponentArray(LayerRoot.TYPE.TIPS, id)
  }

  static _removeComponentTipAll = () => {
    setComponentFunc(LayerRoot.TYPE.TIPS, [])
  }

  static setComponent = (type, com) => {
    if (setComponentFunc) {
