...
const Head = props => {
  ...
  const renderYearSelection = () => {
    ...
    return (
      <div className='t-calendar-years-or-months'>
  ...
  const renderYear = () => {
    ...
    if (selectType === 'year') {
      ...
      return (
        <span className='t-calendar-head-text'>
          {b} ~ {e}
        </span>
      )
    }
    ...
    return (
      <span
        className='t-calendar-head-text'
  ...
  return (
    <>
      <Flex alignCenter className='t-calendar-head t-border-bottom clearfix'>
